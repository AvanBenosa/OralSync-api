...
namespace DMD.APPLICATION.Auth
{
    internal static class AuthResponseFactory
    {
        ...
        internal static AuthResponse Create(
            ...
            bool isContractPolicyAccepted = false,
            bool forBetaTestingAccepted = false,
            bool isLocked = false,
            ...
            string? validityDate = null)
        {
            ...
            return new AuthResponse
            {
                ...
                User = new UserDto
                {
                    ...
                    IsContractPolicyAccepted = isContractPolicyAccepted,
                    ForBetaTestingAccepted = forBetaTestingAccepted,
                    IsLocked = isLocked,
