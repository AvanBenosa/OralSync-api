    ...
    public class QueryHandler : IRequestHandler<Query, Response>
    {
        ...
        public async Task<Response> Handle(Query request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var response = new PatientMedicalHistoryResponseModel
                {
                    Items = new List<PatientMedicalHistoryModel>(),
                ...
                return new SuccessResponse<PatientMedicalHistoryResponseModel>(response);
